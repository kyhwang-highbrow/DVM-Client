...
PATH_LIST = ['ps', 'data_dat', 'res', 'translate', 'sound'] # 암호화를 한 경우 json을 포함하지 않도록 하자 (개발용 폴더니까)

# 복사해서 넣어야하는 폴더
# DVNEW-Client/main/python 기준 상대 경로
ASSETS_PATH = '../runtime-src/proj.android/asset_pack_01/src/main/assets' #D:\DVNEW-Client\main\runtime-src\proj.android\asset_pack_01\src\main
