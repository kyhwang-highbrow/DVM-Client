...
-------------------------------------
-- class UI_TamerSelectPopup
-------------------------------------
UI_TamerSelectPopup = class(PARENT, {
     })

-------------------------------------
-- function init
-------------------------------------
function UI_TamerSelectPopup:init()
    local vars = self:load('tamer_select_popup.ui')
    UIManager:open(self, UIManager.POPUP)

    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:click_exitBtn() end, 'UI_TamerSelectPopup')
...
-------------------------------------
function UI_TamerSelectPopup:click_exitBtn()
    self:close()
end
...
-- function initUI
-------------------------------------
function UI_TamerSelectPopup:initUI()
...
-- function initButton
-------------------------------------
function UI_TamerSelectPopup:initButton()
...
-- function refresh
-------------------------------------
function UI_TamerSelectPopup:refresh()
end
...
-- @brief
-------------------------------------
function UI_TamerSelectPopup:makeTamerListView()
...
--@CHECK
UI:checkCompileError(UI_TamerSelectPopup)
