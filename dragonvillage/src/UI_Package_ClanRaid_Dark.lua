...
----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Dark
----------------------------------------------------------------------
UI_Package_ClanRaid_Dark = class(PARENT, {
...
-- -- function init
-- ----------------------------------------------------------------------
function UI_Package_ClanRaid_Dark:init(struct_product, is_popup)
    self.m_uiName = 'UI_Package_ClanRaid_Dark'
    -- @UI_ACTION
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Dark:initMember()
end

----------------------------------------------------------------------
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Dark:initUI()
    self:initMember()
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_Dark:initButton(is_popup)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Dark:refresh()
    PARENT.refresh(self)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Dark:initTableView()
    local vars = self.vars

    local product_id = self.m_structProduct['product_id']

    cclog('--------------------------------------------------------------')
    cclog('product_id Dark : ' .. product_id)
    cclog('--------------------------------------------------------------')
    ...
    local node
    local isPackagePurchased = g_clanDungeonDarkPackageData:isPackageActive(product_id)
    ...
    local item_list = g_clanDungeonDarkPackageData:getPackageTable(product_id)
    ...
    tableview:setCellUIClass(UI_Package_ClanRaid_DarkListItem, create_func)
    tableview:setDirection(cc.SCROLLVIEW_DIRECTION_VERTICAL)
    tableview:setItemList(item_list, true)
    self.m_tableview = tableview

    if g_clanDungeonDarkPackageData:isPackageActive(product_id) then
        local isReceivableReward = false
        local target_index
        for key, data in pairs(item_list) do
            local dungeon_score = data['achive_2']
            local isRewardReceived = g_clanDungeonDarkPackageData:isRewardReceived(product_id, dungeon_score)
...
----------------------------------------------------------------------
function UI_Package_ClanRaid_Dark:buyCallback(ret)
    ...
    g_clanDungeonDarkPackageData:request_info(self.m_structProduct['product_id'], callback)
end

----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Dark
----------------------------------------------------------------------
UI_Package_ClanRaid_DarkListItem = class(class(UI, ITableViewCell:getCloneTable()), {
    m_data = 'table',
    m_productId = 'string',
    m_stageId = '',
...
-- function init
----------------------------------------------------------------------
function UI_Package_ClanRaid_DarkListItem:init(data)
    self.m_data = data
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_DarkListItem:initUI()
    local vars = self.vars
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_DarkListItem:initButton()
    local vars = self.vars
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_DarkListItem:refresh()
    local vars = self.vars
