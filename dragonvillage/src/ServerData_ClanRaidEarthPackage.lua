...
--------------------------------------------------------------------------
-- class ServerData_ClanRaidEarthPackage
--------------------------------------------------------------------------
ServerData_ClanRaidEarthPackage = class({
...
-- function init
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:init()
    --self.m_serverData = server_data
    self.m_tableName = 'table_battlepass_clan_earth'
    self.m_packageInfo = {}
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:request_info(product_id, cb_func, fail_cb)
    ...
    ui_network:setUrl('/shop/clan_dungeon_score_e/info')
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:response_info(product_info, product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:response_reward(ret, product_id)
    local _product_id = tostring(product_id)
...
-- function response_reward
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:getPackageTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:convertPackageTableKey()
    local package_table = TABLE:get(self.m_tableName)
    local result = {}
    ...
    Coroutine(coroutine_func, 'Clan Raid Earth Package 코루틴')
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:checkProductInTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:isPackageActive(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:isRewardReceived(product_id, dungeon_score)
    --if (not self.m_packageInfo[tostring(product_id)]) then return false end
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:getProductIdWithClanDungeonID(clan_dungeon_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:isVisibleAtBattlePassShop()
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:isNotiVisible()
    local package_table = self:getPackageTable()
    local product_id
    local dungeon_score
    ...
    for i, v in pairs(package_table) do
        for key, data in pairs(v) do
            ...
            if self:isPackageActive(product_id) then
                ...
                and (g_clanRaidData:isClanDungeonEarthRewardAvailable(dungeon_score)) then
                    return true
                end
            else
                break
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:isUnclearedAnyPackage()
    ...
    for i, v in pairs(package_table) do
        for key, data in pairs(v) do 
            product_id = data['product_id']
            if data['type'] == 'clan_dungeon' and data['achive_1'] == 0 then
                if self:isPackageActive(product_id) then
                    dungeon_score = data['achive_2']
...
--------------------------------------------------------------------------
function ServerData_ClanRaidEarthPackage:isPackageVisible(product_id)
    -- if (g_contentLockData:isContentLock('clan_raid')) then 
    --     return false
    -- end
...
--function ServerData_ClanRaidEarthPackage:getProductIdWithMatched
