...
-------------------------------------
-- class UI_ArenaRankingRewardPopup
-------------------------------------
UI_ArenaRankingRewardPopup = class(PARENT,{
    })
...
function UI_ArenaRankingRewardPopup:init(t_info, is_clan)
    ...
    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:close() end, 'UI_ArenaRankingRewardPopup')
...
-- function initUI
-------------------------------------
function UI_ArenaRankingRewardPopup:initUI(t_info, is_clan)
...
-- function initButton
-------------------------------------
function UI_ArenaRankingRewardPopup:initButton()
    local vars = self.vars
...
-- function refresh
-------------------------------------
function UI_ArenaRankingRewardPopup:refresh()
end

--@CHECK
UI:checkCompileError(UI_ArenaRankingRewardPopup)
