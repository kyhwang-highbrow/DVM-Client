...
-------------------------------------
UI_ColosseumDeckSettings = class(PARENT,{
...
-------------------------------------
function UI_ColosseumDeckSettings:refresh_buffInfo_TamerBuff()
...
-------------------------------------
function UI_ColosseumDeckSettings:getCurrTamerID()
...
-- @breif
-------------------------------------
function UI_ColosseumDeckSettings:click_tamerBtn()
    local tamer_id = self:getCurrTamerID()
