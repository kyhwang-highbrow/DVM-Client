...
cclog('@@## PerpleSdkManager:onestoreIsAvailable() 1 : ' .. tostring(PerpleSdkManager:onestoreIsAvailable()))

-------------------------------------
-- function init
-------------------------------------
function Analytics:init()
    cclog('@@## PerpleSdkManager:onestoreIsAvailable() 2 : ' .. tostring(PerpleSdkManager:onestoreIsAvailable()))
