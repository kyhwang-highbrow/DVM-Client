...
-- function init
-------------------------------------
function UI_EventImageQuizListItem_play:init(data_info)
    self.m_dataInfo = data_info
    local vars = self:load('event_image_quiz_item_01.ui')
...
-- function initUI
-------------------------------------
function UI_EventImageQuizListItem_play:initUI()
    local vars = self.vars
    local data_info = self.m_dataInfo
    local step = data_info['step']
    local price = data_info['price']
...
-- function initButton
-------------------------------------
function UI_EventImageQuizListItem_play:initButton()
end

-------------------------------------
-- function refresh
-------------------------------------
function UI_EventImageQuizListItem_play:refresh()
    local vars = self.vars
    local data_info = self.m_dataInfo
