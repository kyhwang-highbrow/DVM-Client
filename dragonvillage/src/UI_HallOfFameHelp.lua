...
function UI_HallOfFameHelpListItem:initUI(data)
	...
	vars['arenaScoreLabel']:setString(data['point_arena'])
	vars['towerScoreLabel']:setString(data['point_ancient'])
	vars['challengeScoreLabel']:setString(data['point_challenge'])
end
