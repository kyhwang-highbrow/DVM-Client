...
-------------------------------------
-- class SkillIndicator_AoESquare_Height_Touch
-------------------------------------
SkillIndicator_AoESquare_Height_Touch = class(PARENT, {
    })

-------------------------------------
-- function init
-------------------------------------
function SkillIndicator_AoESquare_Height_Touch:init(hero, t_skill)
end

-------------------------------------
-- function init_indicator
-------------------------------------
function SkillIndicator_AoESquare_Height_Touch:init_indicator(t_skill)
...
-------------------------------------
function SkillIndicator_AoESquare_Height_Touch:setIndicatorPosition(touch_x, touch_y, pos_x, pos_y)
...
-------------------------------------
function SkillIndicator_AoESquare_Height_Touch:initIndicatorNode()
...
-------------------------------------
function SkillIndicator_AoESquare_Height_Touch:findCollision(x, y)
...
-------------------------------------
function SkillIndicator_AoESquare_Height_Touch:optimizeIndicatorData(l_target, fixed_target)
    local max_count = -1
    local t_best = {}
