...
-------------------------------------
-- class UI_ArenaMatchRewardItem
-------------------------------------
UI_ArenaMatchRewardItem = class(PARENT,{
    })

-------------------------------------
-- function init
-------------------------------------
function UI_ArenaMatchRewardItem:init(t_data)
...
-------------------------------------
function UI_ArenaMatchRewardItem:getCashCount(package_item_str)
