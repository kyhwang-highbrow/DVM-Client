...
-------------------------------------
-- class UI_Package_Step04
-------------------------------------
UI_Package_Step04 = class(PARENT,{
        m_curr_step = 'number',
        m_lStepPids = 'list',
...
-- function init
-------------------------------------
function UI_Package_Step04:init(package_name, is_popup)
...
-- function initStep
-------------------------------------
function UI_Package_Step04:initStep(package_name)
...
-- function initButton
-------------------------------------
function UI_Package_Step04:initButton()
    local vars = self.vars
...
-------------------------------------
function UI_Package_Step04:setCurrentStep()
    local sum_buy_cnt = 0
...
-- function refresh
-------------------------------------
function UI_Package_Step04:refresh(step)
    if (not step) then
        return
    end
...
-------------------------------------
function UI_Package_Step04:setLastRewardLabel(step)
    local vars= self.vars
...
-------------------------------------
function UI_Package_Step04:setBuutonState(clicked_step)
    local vars = self.vars
    for idx = 1, #self.m_lStepPids do
...
-------------------------------------
function UI_Package_Step04:getButtonState(target_step, clicked_step)
    -- 모든 단계를 구매한 경우
...
-------------------------------------
function UI_Package_Step04:click_stepBtn(step)
    self:refresh(step)
end
...
-- function setNoti
-------------------------------------
function UI_Package_Step04:setNoti()
    local vars = self.vars
    local l_item_list = g_shopDataNew:getProductList('package')
...
-------------------------------------
function UI_Package_Step04:click_buyBtn()
    local l_item_list = g_shopDataNew:getProductList('package')
