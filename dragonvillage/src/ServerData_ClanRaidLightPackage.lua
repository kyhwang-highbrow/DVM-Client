...
--------------------------------------------------------------------------
-- class ServerData_ClanRaidLightPackage
--------------------------------------------------------------------------
ServerData_ClanRaidLightPackage = class({
...
-- function init
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:init()
    --self.m_serverData = server_data
    self.m_tableName = 'table_battlepass_clan_light' 
    self.m_packageInfo = {}
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:request_info(product_id, cb_func, fail_cb)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:response_info(product_info, product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:request_reward(product_id, dunegon_score, cb_func, fail_cb)
    local uid = g_userData:get('uid')
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:response_reward(ret, product_id)
    local _product_id = tostring(product_id)
...
-- function response_reward
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:getPackageTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:convertPackageTableKey()
    local package_table = TABLE:get(self.m_tableName)
    local result = {}
    ...
    Coroutine(coroutine_func, 'Clan Raid Light Package 코루틴')
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:checkProductInTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:isRewardReceived(product_id, dungeon_score)
    --if (not self.m_packageInfo[tostring(product_id)]) then return false end
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:getProductIdWithClanDungeonID(clan_dungeon_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:isVisibleAtBattlePassShop()
...
--------------------------------------------------------------------------
function ServerData_ClanRaidLightPackage:isNotiVisible()
    local package_table = self:getPackageTable()
    local product_id
    local dungeon_score
    ...
    for i, v in pairs(package_table) do
        for key, data in pairs(v) do
            ...
            if self:isPackageActive(product_id) then
                ...
                and (g_clanRaidData:isClanDungeonLightRewardAvailable(dungeon_score))then
                    return true
                end
            else
                break
...
--function ServerData_ClanRaidLightPackage:getProductIdWithMatched
