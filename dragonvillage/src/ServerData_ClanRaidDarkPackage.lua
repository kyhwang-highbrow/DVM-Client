...
--------------------------------------------------------------------------
-- class ServerData_ClanRaidDarkPackage
--------------------------------------------------------------------------
ServerData_ClanRaidDarkPackage = class({
...
-- function init
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:init()
    --self.m_serverData = server_data
    self.m_tableName = 'table_battlepass_clan_dark' 
    self.m_packageInfo = {}
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:request_info(product_id, cb_func, fail_cb)
    ...
    ui_network:setUrl('/shop/clan_dungeon_score_d/info')
    ui_network:setParam('uid', uid)
    ui_network:setParam('product_id', product_id)
    ui_network:setParam('dungeon_id', 4)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:response_info(product_info, product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:request_reward(product_id, dunegon_score, cb_func, fail_cb)
    local uid = g_userData:get('uid')
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:response_reward(ret, product_id)
    local _product_id = tostring(product_id)
...
-- function response_reward
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:getPackageTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:convertPackageTableKey()
    local package_table = TABLE:get(self.m_tableName)
    local result = {}
    ...
    Coroutine(coroutine_func, 'Clan Raid Dark Package 코루틴')
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:checkProductInTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:isPackageActive(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:getProductIdWithClanDungeonID(clan_dungeon_id)
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:isVisibleAtBattlePassShop()
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:isNotiVisible()
    local package_table = self:getPackageTable()
    local product_id
    local dungeon_score
    ...
    for i, v in pairs(package_table) do
        for key, data in pairs(v) do
            ...
            if self:isPackageActive(product_id) then
                ...
                and (g_clanRaidData:isClanDungeonDarkRewardAvailable(dungeon_score)) then
                    return true
                end
            else
                break
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:isUnclearedAnyPackage()
...
--------------------------------------------------------------------------
function ServerData_ClanRaidDarkPackage:isPackageVisible(product_id)
    -- if (g_contentLockData:isContentLock('clan_raid')) then 
    --     return false
    -- end
...
--function ServerData_ClanRaidDarkPackage:getProductIdWithMatched
