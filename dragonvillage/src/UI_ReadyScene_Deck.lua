...
function UI_ReadyScene_Deck:checkChangeDeck(next_func)
    ...
    if (b_change) then
        ...
        ui_network:setParam('edid6', self.m_lDeckList[5] and self.m_lDeckList[6] or nil)
        ui_network:setParam('edid7', self.m_lDeckList[5] and self.m_lDeckList[7] or nil)
        ui_network:setParam('edid8', self.m_lDeckList[5] and self.m_lDeckList[8] or nil)
        ui_network:setParam('edid9', self.m_lDeckList[5] and self.m_lDeckList[9] or nil)
