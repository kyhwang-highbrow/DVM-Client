...
-------------------------------------
-- class UI_GameWorldRaidLinger
-------------------------------------
UI_GameWorldRaidLinger = class(PARENT, {})

-------------------------------------
-- function getUIFileName
-------------------------------------
function UI_GameWorldRaidLinger:getUIFileName()
    return 'ingame.ui'
end
...
-- function initUI
-------------------------------------
function UI_GameWorldRaidLinger:initUI()
    PARENT.initUI(self)
...
-------------------------------------
function UI_GameWorldRaidLinger:initHotTimeUI()
	local vars = self.vars
...
-------------------------------------
function UI_GameWorldRaidLinger:init_timeUI(display_wave, time)
    local vars = self.vars
...
-- function setTime
-------------------------------------
function UI_GameWorldRaidLinger:setTime(sec, is_limit)
...
-- @brief 총 피해량 표시
-------------------------------------
function UI_GameWorldRaidLinger:setTotalDamage(total_damage)
    local vars = self.vars
