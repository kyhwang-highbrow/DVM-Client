...
----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Water
----------------------------------------------------------------------
UI_Package_ClanRaid_Water = class(PARENT, {
...
-- -- function init
-- ----------------------------------------------------------------------
function UI_Package_ClanRaid_Water:init(struct_product, is_popup)
    self.m_uiName = 'UI_Package_ClanRaid_Water'
    -- @UI_ACTION
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Water:initMember()
end

----------------------------------------------------------------------
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Water:initUI()
    self:initMember()
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_Water:initButton(is_popup)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Water:refresh()
    PARENT.refresh(self)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Water:initTableView()
    ...
    local node
    local isPackagePurchased = g_clanDungeonWaterPackageData:isPackageActive(product_id)
    ...
    local item_list = g_clanDungeonWaterPackageData:getPackageTable(product_id)
    ...
    tableview:setCellUIClass(UI_Package_ClanRaid_WaterListItem, create_func)
    tableview:setDirection(cc.SCROLLVIEW_DIRECTION_VERTICAL)
    tableview:setItemList(item_list, true)
    self.m_tableview = tableview

    if g_clanDungeonWaterPackageData:isPackageActive(product_id) then
        local isReceivableReward = false
        local target_index
        for key, data in pairs(item_list) do
            local dungeon_score = data['achive_2']
            local isRewardReceived = g_clanDungeonWaterPackageData:isRewardReceived(product_id, dungeon_score)
    
            local curr_score = g_clanRaidData:getClanDungeonWaterScore()
...
----------------------------------------------------------------------
function UI_Package_ClanRaid_Water:buyCallback(ret)
    ...
    g_clanDungeonWaterPackageData:request_info(self.m_structProduct['product_id'], callback)
end

----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Water
----------------------------------------------------------------------
UI_Package_ClanRaid_WaterListItem = class(class(UI, ITableViewCell:getCloneTable()), {
    m_data = 'table',
    m_productId = 'string',
    m_stageId = '',
...
-- function init
----------------------------------------------------------------------
function UI_Package_ClanRaid_WaterListItem:init(data)
    self.m_data = data
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_WaterListItem:initUI()
    local vars = self.vars
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_WaterListItem:initButton()
    local vars = self.vars
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_WaterListItem:refresh()
    local vars = self.vars
...
----------------------------------------------------------------------
function UI_Package_ClanRaid_WaterListItem:click_rewardBtn()
    local product_id = self.m_data['product_id']
    ...
    g_clanDungeonWaterPackageData:request_reward(product_id, dunegon_score, success_cb, fail_cb)
end