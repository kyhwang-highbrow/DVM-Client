...
-------------------------------------
function UI_DragonResearch:refresh_materialTableView()
...
-------------------------------------
function UI_DragonResearch:getMaterialList(doid)
...
-------------------------------------
function UI_DragonResearch:click_material(data)
    local vars = self.vars
    local doid = data['id']
...
-------------------------------------
function UI_DragonResearch:click_transcendBtn()
