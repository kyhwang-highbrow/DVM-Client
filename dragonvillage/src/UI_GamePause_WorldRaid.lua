...
-------------------------------------
--- @class UI_GamePause_WorldRaid
-------------------------------------
UI_GamePause_WorldRaid = class(PARENT, {
     })
...
-- @param body
-------------------------------------
function UI_GamePause_WorldRaid:init(stage_id, gamekey, start_cb, end_cb)
end

-------------------------------------
--- @function click_retryButton
-------------------------------------
function UI_GamePause_WorldRaid:click_retryButton()
...
-------------------------------------
function UI_GamePause_WorldRaid:confirmExit(exit_cb)
