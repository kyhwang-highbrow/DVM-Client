...
-------------------------------------
-- class UI_GrandArenaRankingListItem
-------------------------------------
UI_GrandArenaRankingListItem = class(PARENT, {
        m_rankInfo = '',
    })
...
-- function init
-------------------------------------
function UI_GrandArenaRankingListItem:init(t_rank_info)
    self.m_rankInfo = t_rank_info
    local vars = self:load('grand_arena_ranking_popup_rank_item.ui')
...
-- function initUI
-------------------------------------
function UI_GrandArenaRankingListItem:initUI()
