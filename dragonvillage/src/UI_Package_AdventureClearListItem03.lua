...
-------------------------------------
-- class UI_Package_AdventureClearListItem03
-------------------------------------
UI_Package_AdventureClearListItem03 = class(PARENT, {
        m_data = '',
    })
...
-- function init
-------------------------------------
function UI_Package_AdventureClearListItem03:init(data)
    self.m_data = data
    local vars = self:load('package_adventure_clear_item_03.ui')
...
-- function initUI
-------------------------------------
function UI_Package_AdventureClearListItem03:initUI()
...
-- function initButton
-------------------------------------
function UI_Package_AdventureClearListItem03:initButton()
    local vars = self.vars
...
-- function refresh
-------------------------------------
function UI_Package_AdventureClearListItem03:refresh()
    local vars = self.vars
...
-------------------------------------
function UI_Package_AdventureClearListItem03:click_rewardBtn()
    local data = self.m_data
    local stage_id = data['stage']
...
-- @brief 스테이지 바로가기 버튼
-------------------------------------
function UI_Package_AdventureClearListItem03:click_linkBtn()
    local data = self.m_data
    local stage_id = data['stage']
