...
UI_AttrTowerRank.RANKING = 'rankingList'
UI_AttrTowerRank.REWARD = 'rewardList'
UI_AttrTowerRank.CLAN_RANKING = 'clanRankingList'
UI_AttrTowerRank.CLAN_REWARD = 'clanRewardList'
...
function UI_AttrTowerRank:initButton()
    ...
    radio_button:addButtonAuto(UI_AttrTowerRank.RANKING, vars)
    radio_button:addButtonAuto(UI_AttrTowerRank.REWARD, vars)
    radio_button:addButtonAuto(UI_AttrTowerRank.CLAN_RANKING, vars)
    radio_button:addButtonAuto(UI_AttrTowerRank.CLAN_REWARD, vars)
...
-------------------------------------
function UI_AttrTowerRank:onChangeOption()
    local vars = self.m_uiScene.vars
    local type = self.m_typeRadioButton.m_selectedButton

    vars['rewardListNode']:setVisible(type == UI_AttrTowerRank.REWARD)
    vars['rankingListNode']:setVisible(type == UI_AttrTowerRank.RANKING)
    vars['rankingMeNode']:setVisible(type == UI_AttrTowerRank.RANKING)
    
    vars['clanRewardListNode']:setVisible(type == UI_AttrTowerRank.CLAN_REWARD)
    vars['clanRankNode']:setVisible(type == UI_AttrTowerRank.CLAN_RANKING)

    vars['ancientShopBtn']:setVisible(false)
    vars['clancoinShopBtn']:setVisible(false)
    
    -- 개인 랭킹
    if (type == UI_AttrTowerRank.RANKING) then
    ...
    -- 개인 보상
    elseif (type == UI_AttrTowerRank.REWARD) then
    ...
    -- 클랜 랭킹
    elseif (type == UI_AttrTowerRank.CLAN_RANKING) then
    ...
    -- 클랜 보상
    elseif (type == UI_AttrTowerRank.CLAN_REWARD) then
...
-------------------------------------
function UI_AttrTowerRank:request_clanRank()
...
function UI_AttrTowerRank:init_rankTableView()
    ...
    -- 내 순위
	do
        local ui = UI_AttrTowerRankListItem(g_ancientTowerData.m_playerUserInfo)
    ...
    table_view:setCellUIClass(UI_AttrTowerRankListItem, create_func)
...
-------------------------------------
function UI_AttrTowerRank:init_rewardTableView()
...
-------------------------------------
function UI_AttrTowerRank:makeMyClanRankNode()
    local vars = self.m_uiScene.vars
...
-------------------------------------
function UI_AttrTowerRank:init_clanRankingTableView()
    local vars = self.m_uiScene.vars
...
-------------------------------------
function UI_AttrTowerRank:init_clanRewardTableView()
...
-------------------------------------
function UI_AttrTowerRank:click_ancientShopBtn()
...
-------------------------------------
function UI_AttrTowerRank:click_clancoinShopBtn()
    local ui_shop_popup = UI_Shop()
