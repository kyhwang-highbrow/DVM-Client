...
-------------------------------------
-- class StructRankReward
-- @brief 콜로세움 랭킹 보상 리스트
-------------------------------------
StructRankReward = class({
...
-- function init
-------------------------------------
function StructRankReward:init(table_reward, is_skip_filter_week)
    local l_rank_reward = {}
...
-------------------------------------
function StructRankReward:getRankRewardList()
...
--}
-------------------------------------
function StructRankReward.getRankName(t_list_item)
