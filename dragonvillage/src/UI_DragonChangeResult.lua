...
-------------------------------------
-- class UI_DragonChangeResult
-------------------------------------
UI_DragonChangeResult = class(PARENT, {
        m_dragon_data = '',
        m_dragon_animator = '',
...
-- function initButton
-------------------------------------
function UI_DragonChangeResult:initButton()
...
-- @brief 능력치 정보 갱신
-------------------------------------
function UI_DragonChangeResult:setResultText(dragon_data)
    -- ### 파생 클래스에서 구현 ###
end
...
-------------------------------------
function UI_DragonChangeResult:showEvolutionEffect()
    local vars = self.vars
    ...
    -- 드래곤 하단 이펙트
    do 
        local visual = vars['evolutionVisual1'] or vars['changeVisual1']
    ...
    -- 드래곤 상단 이펙트
    do 
        local visual = vars['evolutionVisual2'] or vars['changeVisual2']
        visual:setVisible(true)
    ...
    do
        ...
        local target_evolution = self.m_before_evolution or evolution-1
...
-- function showResult
-------------------------------------
function UI_DragonChangeResult:showResult(immediately)
    local vars = self.vars

    local dragon_node = vars['dragonNode']
    local dragon_object = self.m_dragon_data
...
-------------------------------------
function UI_DragonChangeResult:fadeOutClose()
...
-------------------------------------
function UI_DragonChangeResult:click_skipBtn()
    local vars = self.vars 
