...
-------------------------------------
-- class UI_ArenaClanRankListItem
-------------------------------------
UI_ArenaClanRankListItem = class(PARENT, {
...
-- function initUI
-------------------------------------
function UI_ArenaClanRankListItem:initUI()
...
-- function initButton
-------------------------------------
function UI_ArenaClanRankListItem:initButton()
end

-------------------------------------
-- function refresh
-------------------------------------
function UI_ArenaClanRankListItem:refresh()
end
