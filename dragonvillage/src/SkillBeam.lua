...
-- @param body
-------------------------------------
function SkillBeam:init(file_name, body, ...)
end

-------------------------------------
-- function init_skill
-------------------------------------
function SkillBeam:init_skill(missile_res, target_count)
...
-- function initState
-------------------------------------
function SkillBeam:initState()
	self:setCommonState(self)
    self:addState('start', SkillBeam.st_idle, 'idle', true)
end

-------------------------------------
-- function st_idle
-------------------------------------
function SkillBeam.st_idle(owner, dt)
...
-- @overriding
-------------------------------------
function SkillBeam:makeEffect(res, idx)
    local file_name = res
...
-------------------------------------
function SkillBeam:setTemporaryPause(pause)
...
-- @param missile_res 
-------------------------------------
function SkillBeam:makeSkillInstance(owner, t_skill, t_data)
	-- 변수 선언부
	------------------------------------------------------
