-------------------------------------
-- class UI_ColosseumReadyScene_Deck
-------------------------------------
UI_ColosseumReadyScene_Deck = class({
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:click_chBtn(idx)
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:click_dragonCard(t_dragon_data, skip_sort)
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:setFocusDeckSlotEffect(idx)
    local vars = self.m_uiReadyScene.vars
...
-- function clear_deck
-------------------------------------
function UI_ColosseumReadyScene_Deck:clear_deck(skip_sort)
    do -- UI 정리
...
-- function init_deck
-------------------------------------
function UI_ColosseumReadyScene_Deck:init_deck()
    do -- UI 정리
        if self.m_lSettedDragonCard then
            for _,ui in pairs(self.m_lSettedDragonCard) do
                ui.root:removeFromParent()
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:convertSimpleDeck(l_deck)
    -- 변경이 필요한지 체크
...
-- @breif
-------------------------------------
function UI_ColosseumReadyScene_Deck:makeSettedDragonCard(t_dragon_data, idx)
    local vars = self.m_uiReadyScene.vars
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:refresh_dragonCard(doid)
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:checkChangeDeck(next_func)
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:getDragonCount()
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:updateFormationInfo(formation)
	local vars = self.m_uiReadyScene.vars
...
-- @brief 터치 레이어 생성
-------------------------------------
function UI_ColosseumReadyScene_Deck:makeTouchLayer_formation(target_node)
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:onTouchMoved(touch, event)
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:onTouchEnded(touch, event)
    self:moveSelectDragonCard(touch, event)
...
-------------------------------------
function UI_ColosseumReadyScene_Deck:moveSelectDragonCard(touch, event)
    local vars = self.m_uiReadyScene.vars
