...
function UI_DragonDetailPopup:refresh()
    ...
    do -- 능력치 입력
        ...
        if doid then
            ...
            status_calc = MakeDragonStatusCalculator(t_dragon_data['did'], t_dragon_data['lv'], t_dragon_data['grade'], t_dragon_data['evolution'], t_dragon_data['eclv'], t_dragon_data['rlv'])
        end
