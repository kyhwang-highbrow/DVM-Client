...
-------------------------------------
-- class UI_ButtonSpecialOfferProduct
-- @brief 관리되는 버튼 (버튼이 노출되는 여부에 따라 상위 메뉴에서 위치 변경)
-- @used_at 
-------------------------------------
UI_ButtonSpecialOfferProduct = class(PARENT, {
        m_bActive = 'boolean',
    })
...
-- function init
-------------------------------------
function UI_ButtonSpecialOfferProduct:init()
    self:load('button_special_offer_product.ui')
...
-- function isActive
-------------------------------------
function UI_ButtonSpecialOfferProduct:isActive()
...
-------------------------------------
function UI_ButtonSpecialOfferProduct:update(dt)
...
-------------------------------------
function UI_ButtonSpecialOfferProduct:updateButtonStatus()
