...
function UI_UserLevelUp:initUI()
    ...
    do
        ...
        -- 스태미나 선물
        local st_item_id = 700101
        local st_count = TableUserLevel():getStaminaGift(prev_lv, curr_lv)
        local stamina_card = UI_ItemCard(st_item_id, st_count)
        vars['itemNode']:addChild(stamina_card.root)
