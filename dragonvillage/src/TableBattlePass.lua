...
-------------------------------------
function TableBattlePass:getDataWithName(package_name)
    if (self == THIS) then
        self = THIS()
    end
...
-- @brief 등록된 패키지인지 
-------------------------------------
function TableBattlePass:checkBundleWithName(package_name)
    if (self == THIS) then
        self = THIS()
    end
...
-------------------------------------
function TableBattlePass:getPackageNameWithPid(pid)
    if (self == THIS) then
        self = THIS()
    end
...
-------------------------------------
function TableBattlePass:getPackageDescWithPid(pid)
    if (self == THIS) then
        self = THIS()
    end
...
-------------------------------------
function TableBattlePass:getPidsWithName(package_name)
    if (self == THIS) then
        self = THIS()
    end
...
-- function getPids
-------------------------------------
function TableBattlePass:getPids(pid)
    if (self == THIS) then
        self = THIS()
    end
...
-------------------------------------
function TableBattlePass:isSelectOnePackage(package_name)
    if (self == THIS) then
        self = THIS()
    end
...
-------------------------------------
function TableBattlePass:isBuyableLv(package_name, user_lv)
    if (self == THIS) then
        self = THIS()
    end
