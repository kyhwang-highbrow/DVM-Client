...
-------------------------------------
-- class SkillHealAoESquare_Height
-------------------------------------
SkillHealAoESquare_Height = class(PARENT, {
    })
...
-- @param body
-------------------------------------
function SkillHealAoESquare_Height:init(file_name, body, ...)
end

-------------------------------------
-- function init_skill
-------------------------------------
function SkillHealAoESquare_Height:init_skill(hit)
...
-------------------------------------
function SkillHealAoESquare_Height:initSkillSize()
...
-- function runAttack
-------------------------------------
function SkillHealAoESquare_Height:runAttack()
    self:runHeal()
end
...
-------------------------------------
function SkillHealAoESquare_Height:adjustAnimator()    
...
-------------------------------------
function SkillHealAoESquare_Height:findCollision()
...
-------------------------------------
function SkillHealAoESquare_Height:makeSkillInstance(owner, t_skill, t_data)
	-- 변수 선언부
	------------------------------------------------------
	...
	------------------------------------------------------
	-- 1. 스킬 생성
    local skill = SkillHealAoESquare_Height(missile_res)
