...
-------------------------------------
-- class UI_ChatListItem_broadcast
-------------------------------------
UI_ChatListItem_broadcast = class(PARENT, {
...
-- function init
-------------------------------------
function UI_ChatListItem_broadcast:init(chat_content)
    ...
    local rich_label = vars['chatLabel']
    rich_label:setDimension(300, 100)
...
-------------------------------------
function UI_ChatListItem_broadcast:getBroadcastChannelRange(channel_name)
...
-- function initUI
-------------------------------------
function UI_ChatListItem_broadcast:initUI()
...
-- function initButton
-------------------------------------
function UI_ChatListItem_broadcast:initButton()
    local vars = self.vars
end
...
-- function refresh
-------------------------------------
function UI_ChatListItem_broadcast:refresh()
end

-------------------------------------
-- function getCellSize
-------------------------------------
function UI_ChatListItem_broadcast:getCellSize()
    local width, height = self.root:getNormalSize()
