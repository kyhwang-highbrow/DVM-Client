...
-------------------------------------
function SkillConicAtk:makeSkillInstnce(attack_count, range, missile_res, ...)
	-- 1. 스킬 생성
...
function SkillConicAtk:makeSkillInstnceFromSkill(owner, t_skill, t_data)
    ...
    SkillConicAtk:makeSkillInstnce(attack_count, range, missile_res, owner, power_rate, target_type, pre_delay, status_effect_type, status_effect_value, status_effect_rate, skill_type, tar_x, tar_y, target)
end
