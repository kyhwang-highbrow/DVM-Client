...
-------------------------------------
-- class GameState_RuneGuardianDungeon
-------------------------------------
GameState_RuneGuardianDungeon = class(PARENT, {
    })
...
-------------------------------------
function GameState_RuneGuardianDungeon:init()
...
-------------------------------------
function GameState_RuneGuardianDungeon:makeResultUI(is_success)
    -- 작업 함수들
    ...
    func_ui_result = function()
        ...
        UI_GameResult_RuneGuardianDungeon(stage_id,
            is_success,
            self.m_fightTimer,
