...
-- @breif
-------------------------------------
function SceneGameChallengeMode:networkGameFinish(t_param, t_result_ref, next_func)
...
-------------------------------------
function SceneGameChallengeMode:networkGameFinish_response(ret, t_result_ref)
...
-------------------------------------
function SceneGameChallengeMode:networkGameFinish_response_user_info(ret, t_result_ref)
...
-------------------------------------
function SceneGameChallengeMode:networkGameFinish_response_modified_dragons(ret, t_result_ref)
...
-------------------------------------
function SceneGameChallengeMode:networkGameFinish_response_added_dragons(ret, t_result_ref)
...
-- @breif 드랍 보상 데이터 처리
-------------------------------------
function SceneGameChallengeMode:networkGameFinish_response_drop_reward(ret, t_result_ref)
