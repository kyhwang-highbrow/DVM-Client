...
----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Earth
----------------------------------------------------------------------
UI_Package_ClanRaid_Earth = class(PARENT, {
...
-- -- function init
-- ----------------------------------------------------------------------
function UI_Package_ClanRaid_Earth:init(struct_product, is_popup)
    self.m_uiName = 'UI_Package_ClanRaid_Earth'
    -- @UI_ACTION
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Earth:initMember()
end

----------------------------------------------------------------------
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Earth:initUI()
    self:initMember()
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_Earth:initButton(is_popup)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Earth:refresh()
    PARENT.refresh(self)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Earth:initTableView()
    local vars = self.vars

    local product_id = self.m_structProduct['product_id']

    cclog('--------------------------------------------------------------')
    cclog('product_id Earth : ' .. product_id)
    cclog('--------------------------------------------------------------')
    ...
    local node
    local isPackagePurchased = g_clanDungeonEarthPackageData:isPackageActive(product_id)
    ...
    local item_list = g_clanDungeonEarthPackageData:getPackageTable(product_id)
    ...
    tableview:setCellUIClass(UI_Package_ClanRaid_EarthListItem, create_func)
    tableview:setDirection(cc.SCROLLVIEW_DIRECTION_VERTICAL)
    tableview:setItemList(item_list, true)
    self.m_tableview = tableview

    if g_clanDungeonEarthPackageData:isPackageActive(product_id) then
        local isReceivableReward = false
        local target_index
        for key, data in pairs(item_list) do
            local dungeon_score = data['achive_2']
            local isRewardReceived = g_clanDungeonEarthPackageData:isRewardReceived(product_id, dungeon_score)
...
----------------------------------------------------------------------
function UI_Package_ClanRaid_Earth:buyCallback(ret)
    ...
    g_clanDungeonEarthPackageData:request_info(self.m_structProduct['product_id'], callback)
end

----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Earth
----------------------------------------------------------------------
UI_Package_ClanRaid_EarthListItem = class(class(UI, ITableViewCell:getCloneTable()), {
    m_data = 'table',
    m_productId = 'string',
    m_stageId = '',
...
-- function init
----------------------------------------------------------------------
function UI_Package_ClanRaid_EarthListItem:init(data)
    self.m_data = data
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_EarthListItem:initUI()
    local vars = self.vars
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_EarthListItem:initButton()
    local vars = self.vars
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_EarthListItem:refresh()
    local vars = self.vars
