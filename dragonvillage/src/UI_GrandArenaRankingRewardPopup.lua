...
-------------------------------------
-- class UI_GrandArenaRankingRewardPopup
-------------------------------------
UI_GrandArenaRankingRewardPopup = class(PARENT,{
    })

-------------------------------------
-- function init
-------------------------------------
function UI_GrandArenaRankingRewardPopup:init(t_info)
    local vars = self:load('grand_arena_ranking_reward_popup.ui')
    UIManager:open(self, UIManager.POPUP)

    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:close() end, 'UI_GrandArenaRankingRewardPopup')
...
-- function initUI
-------------------------------------
function UI_GrandArenaRankingRewardPopup:initUI(t_info)
...
-- function initButton
-------------------------------------
function UI_GrandArenaRankingRewardPopup:initButton()
    local vars = self.vars
...
-- function refresh
-------------------------------------
function UI_GrandArenaRankingRewardPopup:refresh()
end

--@CHECK
UI:checkCompileError(UI_GrandArenaRankingRewardPopup)
