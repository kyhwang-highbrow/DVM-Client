-------------------------------------
-- class CameraTouchHandler_Lobby
-- @brief 카메라의 터치를 관리하는 클래스
-------------------------------------
CameraTouchHandler_Lobby = class({
        m_camera = 'Camera',
...
-- function init
-------------------------------------
function CameraTouchHandler_Lobby:init(camera, target_node)
...
-------------------------------------
function CameraTouchHandler_Lobby:getDistance(x1, y1, x2, y2)
...
-- @brief 터치 레이어 생성
-------------------------------------
function CameraTouchHandler_Lobby:makeTouchLayer(target_node)
...
-------------------------------------
function CameraTouchHandler_Lobby:onTouchBegan(touches, event)
    --cclog('CameraTouchHandler_Lobby:onTouchBegan')
    self.m_tapTimer = 0
...
-------------------------------------
function CameraTouchHandler_Lobby:onTouchMoved(touches, event)
    --cclog('CameraTouchHandler_Lobby:onTouchMoved')
    if self.m_dobleTapDelay > 0 then
        return
    end
...
-------------------------------------
function CameraTouchHandler_Lobby:onTouchEnded(touches, event)
    --cclog('CameraTouchHandler_Lobby:onTouchEnded')
...
-------------------------------------
function CameraTouchHandler_Lobby:onDoubleTap(touches, event)
...
-------------------------------------
function CameraTouchHandler_Lobby:makeKeypad(target_node)
...
-------------------------------------
function CameraTouchHandler_Lobby:onKeyPressed(keyCode, event)
...
-------------------------------------
function CameraTouchHandler_Lobby:onKeyReleased(keyCode, event)
...
-------------------------------------
function CameraTouchHandler_Lobby:makeScheduleUpdate(target_node)
...
-- function update
-------------------------------------
function CameraTouchHandler_Lobby:update(dt)
