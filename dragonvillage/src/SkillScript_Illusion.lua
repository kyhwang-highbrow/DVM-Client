...
-- @breif 이벤트 처리..
-------------------------------------
function SkillScript_Illusion:initEventListener()
...
-- @brief 멤버변수 정의
-------------------------------------
function SkillScript_Illusion:setSkillParams(owner, t_skill, t_data)
...
-- function initState
-------------------------------------
function SkillScript_Illusion:initState()
    self:setCommonState(self)
	
    self:addState('start', SkillScript_Illusion.st_appear, nil, false)
    self:addState('attack', SkillScript_Illusion.st_attack, nil, false)
    self:addState('end', SkillScript_Illusion.st_disappear, nil, false)
end

-------------------------------------
-- function st_appear
-------------------------------------
function SkillScript_Illusion.st_appear(owner, dt)
...
-- function st_attack
-------------------------------------
function SkillScript_Illusion.st_attack(owner, dt)
	if (owner.m_stateTimer == 0) then
        local unit = owner.m_owner
...
-------------------------------------
function SkillScript_Illusion.st_disappear(owner, dt)
	if (owner.m_stateTimer == 0) then
        local unit = owner.m_owner
...
-- function runAttack
-------------------------------------
function SkillScript_Illusion:runAttack()
    -- attack pos 가져옴
...
-------------------------------------
function SkillScript_Illusion:makeSkillInstance(owner, t_skill, t_data)
	-- 변수 선언부
	------------------------------------------------------
	...
	------------------------------------------------------
	-- 1. 스킬 생성
    local skill = SkillScript_Illusion(res)
	-- 2. 초기화 관련 함수
