...
-------------------------------------
-- class SkillAoESquare_Width_Right
-------------------------------------
SkillAoESquare_Width_Right = class(PARENT, {
     })
...
-- @param body
-------------------------------------
function SkillAoESquare_Width_Right:init(file_name, body, ...)
end

-------------------------------------
-- function init_skill
-------------------------------------
function SkillAoESquare_Width_Right:init_skill(hit)
...
-------------------------------------
function SkillAoESquare_Width_Right:initSkillSize()
...
-------------------------------------
function SkillAoESquare_Width_Right:adjustAnimator()    
...
-------------------------------------
function SkillAoESquare_Width_Right:findCollision()
...
-------------------------------------
function SkillAoESquare_Width_Right:makeSkillInstance(owner, t_skill, t_data)
	-- 변수 선언부
	------------------------------------------------------
	...
	------------------------------------------------------
	-- 1. 스킬 생성
    local skill = SkillAoESquare_Width_Right(missile_res)
