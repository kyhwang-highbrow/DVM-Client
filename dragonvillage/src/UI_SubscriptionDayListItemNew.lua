...
-------------------------------------
-- class UI_SubscriptionDayListItemNew
-------------------------------------
UI_SubscriptionDayListItemNew = class(PARENT, {
        m_data = '',
    })
...
-- function init
-------------------------------------
function UI_SubscriptionDayListItemNew:init(data)
    self.m_data = data
    local vars = self:load('package_daily_dia_reward_item_new.ui')
...
-- function initUI
-------------------------------------
function UI_SubscriptionDayListItemNew:initUI()
...
-- function initButton
-------------------------------------
function UI_SubscriptionDayListItemNew:initButton()
end

-------------------------------------
-- function refresh
-------------------------------------
function UI_SubscriptionDayListItemNew:refresh()
end
