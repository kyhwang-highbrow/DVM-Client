...
----------------------------------------------------------------------
-- class UI_Package_ClanDungeonScore
----------------------------------------------------------------------
UI_Package_ClanDungeonScore = class(PARENT, {
...
-- -- function init
-- ----------------------------------------------------------------------
function UI_Package_ClanDungeonScore:init(struct_product, is_popup)
    self.m_uiName = 'UI_Package_ClanDungeonScore'
    -- @UI_ACTION
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanDungeonScore:initMember()
end

----------------------------------------------------------------------
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanDungeonScore:initUI()
    self:initMember()
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanDungeonScore:initButton(is_popup)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanDungeonScore:refresh()
    PARENT.refresh(self)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanDungeonScore:initTableView()
    ...
    tableview:setCellUIClass(UI_Package_ClanDungeonScoreListItem, create_func)
...
----------------------------------------------------------------------
function UI_Package_ClanDungeonScore:buyCallback(ret)
...
-- class UI_Package_ClanDungeonScore
----------------------------------------------------------------------
UI_Package_ClanDungeonScoreListItem = class(class(UI, ITableViewCell:getCloneTable()), {
    m_data = 'table',
    m_productId = 'string',
    m_stageId = '',
...
-- function init
----------------------------------------------------------------------
function UI_Package_ClanDungeonScoreListItem:init(data)
    self.m_data = data
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanDungeonScoreListItem:initUI()
    local vars = self.vars
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanDungeonScoreListItem:initButton()
    local vars = self.vars
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanDungeonScoreListItem:refresh()
    local vars = self.vars
...
----------------------------------------------------------------------
function UI_Package_ClanDungeonScoreListItem:click_rewardBtn()
    local product_id = self.m_data['product_id']
    local stage_id = self.m_data['achive_2']
