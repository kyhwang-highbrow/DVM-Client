...
function SkillIndicator_Target:onChangeTargetCount(old_target_count, cur_target_count)
    ...
    if (old_target_count == 0) and (cur_target_count > 0) then
        self.m_indicatorLinkEffect.m_startPointNode:changeAni('ally_start_idle', true)
        self.m_indicatorLinkEffect.m_effectNode:changeAni('ally_bar_idle', true)
        self.m_indicatorLinkEffect.m_endPointNode:changeAni('ally_end_idle', true)
