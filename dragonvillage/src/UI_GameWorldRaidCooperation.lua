...
-------------------------------------
-- class UI_GameWorldRaidCooperation
-------------------------------------
UI_GameWorldRaidCooperation = class(PARENT, {})

-------------------------------------
-- function getUIFileName
-------------------------------------
function UI_GameWorldRaidCooperation:getUIFileName()
    return 'ingame.ui'
end
...
-- function initUI
-------------------------------------
function UI_GameWorldRaidCooperation:initUI()
    PARENT.initUI(self)
...
-------------------------------------
function UI_GameWorldRaidCooperation:initHotTimeUI()
	local vars = self.vars
...
-------------------------------------
function UI_GameWorldRaidCooperation:init_timeUI(display_wave, time)
    local vars = self.vars
...
-- function setTime
-------------------------------------
function UI_GameWorldRaidCooperation:setTime(sec, is_limit)
...
-- @brief 총 피해량 표시
-------------------------------------
function UI_GameWorldRaidCooperation:setTotalDamage(total_damage)
    local vars = self.vars
