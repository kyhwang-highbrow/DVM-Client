...
-- @brief
-------------------------------------
function StatusCalculator:setStageAdd(stat_type, value)
    local indivisual_status = self.m_lStatusList[stat_type]
    if (not indivisual_status) then
        error('stat_type : ' .. stat_type)
    end
    ...
    -- 특정 타입의 스텟들은 무조건 곱연산
    if (M_SPECIAL_STATUS_TYPE_ONLY_MULTI[stat_type]) then
        indivisual_status:setStageMulti(value)
    else
        indivisual_status:setStageAdd(value)
    end
end
...
-- @brief
-------------------------------------
function StatusCalculator:setStageMulti(stat_type, value)
    local indivisual_status = self.m_lStatusList[stat_type]
    if (not indivisual_status) then
        error('stat_type : ' .. stat_type)
    end
...
-- @brief
-------------------------------------
function StatusCalculator:getStatusList()
    return self.m_lStatusList
end
