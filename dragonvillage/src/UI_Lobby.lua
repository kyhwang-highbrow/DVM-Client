...
function UI_Lobby:update_highlight()
    ...
    local function highlight_func()
        ...
        do -- 핫타임
            local visible = g_hotTimeData:isHighlightHotTime() or g_fevertimeData:isActiveFevertime_adventure() or g_fevertimeData:isActiveFevertime_dungeonGdItemUp() or g_fevertimeData:isActiveFevertime_dungeonGtItemUp()
