...
-- function init
-------------------------------------
function GameState_WorldRaid_Linger:init(world)
...
function GameState_WorldRaid_Linger:initState()
    ...
    self:addState(GAME_STATE_START, GameState_WorldRaid_Linger.update_start)
    self:addState(GAME_STATE_FIGHT, GameState_WorldRaid_Linger.update_fight)
    self:addState(GAME_STATE_RESULT, GameState_WorldRaid_Linger.update_result)
end

-------------------------------------
-- function update_start
-------------------------------------
function GameState_WorldRaid_Linger.update_start(self, dt)
...
-------------------------------------
function GameState_WorldRaid_Linger:doDirectionForIntermission()
    local t_camera_info = {}
...
-------------------------------------
function GameState_WorldRaid_Linger.update_fight(self, dt)
    local world = self.m_world
...
-------------------------------------
function GameState_WorldRaid_Linger.update_result(self, dt)
    if (self.m_stateTimer == 0) then
...
-- function makeBossHp
-------------------------------------
function GameState_WorldRaid_Linger:makeBossHp()
    local world = self.m_world
...
-------------------------------------
function GameState_WorldRaid_Linger:makeResultUI(is_success)
...
-------------------------------------
function GameState_WorldRaid_Linger:disappearAllDragon()
...
-- @brief
-------------------------------------
function GameState_WorldRaid_Linger:onEvent(event_name, t_event, ...)
...
-------------------------------------
function GameState_WorldRaid_Linger:processTimeOut()
...
-------------------------------------
function GameState_WorldRaid_Linger:getTotalDamage()
...
--- @return integer
-------------------------------------
function GameState_WorldRaid_Linger:getRemainFeverTime()
...
-------------------------------------
function GameState_WorldRaid_Linger:updateFightTimer(dt)
