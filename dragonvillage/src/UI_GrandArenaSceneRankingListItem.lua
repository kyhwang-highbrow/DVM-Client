...
-------------------------------------
-- class UI_GrandArenaSceneRankingListItem
-------------------------------------
UI_GrandArenaSceneRankingListItem = class(PARENT, {
        m_rankInfo = '',
    })
...
-- function init
-------------------------------------
function UI_GrandArenaSceneRankingListItem:init(t_rank_info)
    self.m_rankInfo = t_rank_info
    local vars = self:load('grand_arena_scene_top_rank_item.ui')
...
-- function initUI
-------------------------------------
function UI_GrandArenaSceneRankingListItem:initUI()
