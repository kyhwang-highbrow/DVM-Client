...
T_CHAPTER_MAP_RES[7] = 'res/bg/map_volcano/map_volcano.vrp'
T_CHAPTER_MAP_RES[8] = 'res/bg/map_canyon/map_canyon.vrp'
T_CHAPTER_MAP_RES[9] = 'res/bg/map_ocean/map_ocean.vrp'
T_CHAPTER_MAP_RES[10] = 'res/bg/map_forest/map_forest.vrp'
T_CHAPTER_MAP_RES[11] = 'res/bg/map_sky_temple/map_sky_temple.vrp'
