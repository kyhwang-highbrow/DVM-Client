...
-------------------------------------
-- class UI_EventPopupTab_EventAttendanceGoogleFeatured
-------------------------------------
UI_EventPopupTab_EventAttendanceGoogleFeatured = class(PARENT,{
...
-- function init
-------------------------------------
function UI_EventPopupTab_EventAttendanceGoogleFeatured:init(atd_id)
    -- 비어있는 껍데이 UI
...
-- function initUI
-------------------------------------
function UI_EventPopupTab_EventAttendanceGoogleFeatured:initUI()
    local node = self.vars['listNode']
    local struct_attendance_data = self.m_structAttendanceData -- StructAttendanceData
    
    require('UI_AttendanceSpecialListItem_GoogleFeatured')
    local list_ui = UI_AttendanceSpecialListItem_GoogleFeatured(struct_attendance_data)
...
-- @brief 오늘 획득한 보상 팝업
-------------------------------------
function UI_EventPopupTab_EventAttendanceGoogleFeatured:checkTodayRewardPopup()
...
-- @brief
-------------------------------------
function UI_EventPopupTab_EventAttendanceGoogleFeatured:onEnterTab()
    local vars = self.vars
end