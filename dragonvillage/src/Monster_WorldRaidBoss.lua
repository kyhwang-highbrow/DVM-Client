...
-------------------------------------
Monster_WorldRaidBoss = class(PARENT, {
    m_dmglist = '',
     })
...
-- @param body
-------------------------------------
function Monster_WorldRaidBoss:init(file_name, body, ...)
...
-- function initState
-------------------------------------
function Monster_WorldRaidBoss:initState()
...
-- function st_attack
-------------------------------------
function Monster_WorldRaidBoss.st_attack(owner, dt)
...
-- function st_dying
-------------------------------------
function Monster_WorldRaidBoss.st_dying(owner, dt)
...
-------------------------------------
function Monster_WorldRaidBoss:animatorSpot()
...
-------------------------------------
function Monster_WorldRaidBoss:runAction_dyingShake()
    local target_node = self.m_animator.m_node
    if (not target_node) then
        return
    end
...
-- function setDamage
-------------------------------------
function Monster_WorldRaidBoss:setDamage(attacker, defender, i_x, i_y, damage, t_info)
    -- 충돌영역 위치로 변경
...
-------------------------------------
function Monster_WorldRaidBoss:insertStatusEffect(status_effect)    
...
-------------------------------------
function Monster_WorldRaidBoss:getPosForFormation()
