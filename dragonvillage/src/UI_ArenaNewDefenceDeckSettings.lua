...
-------------------------------------
-- class UI_ArenaNewDefenceDeckSettings
-------------------------------------
...
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:initParentVariable()
    -- ITopUserInfo_EventListener의 맴버 변수들 설정
    self.m_uiName = 'UI_ArenaNewDefenceDeckSettings'
...
-- function init
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:init(stage_id, sub_info)
...
-- @brief
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:update_stamina(dt)    
    local vars = self.vars
...
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:refresh_buffInfo_TamerBuff()
    local vars = self.vars
...
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:getCurrTamerID()
...
-- @breif
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:click_tamerBtn()
    local tamer_id = self:getCurrTamerID()
...
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:click_backBtn()
	self:click_exitBtn()
end
...
-- @brief 시작 버튼
-------------------------------------
function UI_ArenaNewDefenceDeckSettings:click_startBtn()
