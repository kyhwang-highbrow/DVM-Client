...
-------------------------------------
-- class UI_GameWorldRaidNormal
-------------------------------------
UI_GameWorldRaidNormal = class(PARENT, {})

-------------------------------------
-- function getUIFileName
-------------------------------------
function UI_GameWorldRaidNormal:getUIFileName()
    return 'ingame.ui'
end
...
-- function initUI
-------------------------------------
function UI_GameWorldRaidNormal:initUI()
    PARENT.initUI(self)
...
-------------------------------------
function UI_GameWorldRaidNormal:initHotTimeUI()
	local vars = self.vars
...
-------------------------------------
function UI_GameWorldRaidNormal:init_timeUI(display_wave, time)
    local vars = self.vars
...
-- function setTime
-------------------------------------
function UI_GameWorldRaidNormal:setTime(sec, is_limit)
...
-- @brief 총 피해량 표시
-------------------------------------
function UI_GameWorldRaidNormal:setTotalDamage(total_damage)
    local vars = self.vars
