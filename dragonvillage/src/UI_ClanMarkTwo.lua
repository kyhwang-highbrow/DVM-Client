...
-------------------------------------
-- class UI_ClanMarkTwo
-------------------------------------
UI_ClanMarkTwo = class(PARENT, {
...
-- function init
-------------------------------------
function UI_ClanMarkTwo:init(struct_clan_mark)
    ...
    self.m_uiName = 'UI_ClanMarkTwo'
    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:click_exitBtn() end, 'UI_ClanMarkTwo')
...
-------------------------------------
function UI_ClanMarkTwo:click_exitBtn()
...
-- function initUI
-------------------------------------
function UI_ClanMarkTwo:initUI()
...
-- function initButton
-------------------------------------
function UI_ClanMarkTwo:initButton()
    local vars = self.vars
...
-------------------------------------
function UI_ClanMarkTwo:click_randomBtn()
...
-------------------------------------
function UI_ClanMarkTwo:click_okBtn()
...
-- function refresh
-------------------------------------
function UI_ClanMarkTwo:refresh()
    local vars = self.vars
...
-- function initTab
-------------------------------------
function UI_ClanMarkTwo:initTab()
    local vars = self.vars
...
-------------------------------------
function UI_ClanMarkTwo:onChangeTab(tab, first)
    self:init_TableView()
end
...
-------------------------------------
function UI_ClanMarkTwo:init_TableView()
...
-------------------------------------
function UI_ClanMarkTwo:getTableViewItemList()
    local l_item_list
...
-------------------------------------
function UI_ClanMarkTwo:click_listItem(ui, data)
...
--@CHECK
UI:checkCompileError(UI_ClanMarkTwo)
