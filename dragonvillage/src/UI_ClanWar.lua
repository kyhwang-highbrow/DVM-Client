...
-------------------------------------
function UI_ClanWar:initParentVariable()
    -- ITopUserInfo_EventListener의 맴버 변수들 설정
    self.m_uiName = 'UI_ClanWar'
...
-------------------------------------
function UI_ClanWar:click_exitBtn()
    self:close()
end
...
-- function init
-------------------------------------
function UI_ClanWar:init(ret)
    local vars = self:load('clan_war_lobby.ui')
    UIManager:open(self, UIManager.SCENE)

    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:closeUI() end, 'UI_ClanWar')
...
-- function initUI
-------------------------------------
function UI_ClanWar:initUI(ret)
    ...
    self.m_groupPaging:setGroup(20)
...
-- function initButton
-------------------------------------
function UI_ClanWar:initButton()
    local vars = self.vars
end
...
-------------------------------------
function UI_ClanWar:getStructClanWarLeague(group, cb)
...
-- @brief 조별 순위 UI
-------------------------------------
function UI_ClanWar:setGroupRankList(struct_league)
    local vars = self.vars
...
-- @brief 조별 경기 리스트 UI
-------------------------------------
function UI_ClanWar:setGroupMatchList()
    local vars = self.vars
...
-------------------------------------
function UI_ClanWar:setAllGroupRankList()
    local vars = self.vars
