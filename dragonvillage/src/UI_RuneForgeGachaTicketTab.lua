...
-------------------------------------
-- class UI_RuneForgeGachaTicketTab
-------------------------------------
UI_RuneForgeGachaTicketTab = class(PARENT,{
...
-- function init
-------------------------------------
function UI_RuneForgeGachaTicketTab:init(owner_ui)
...
-- function onEnterTab
-------------------------------------
function UI_RuneForgeGachaTicketTab:onEnterTab(first)
...
-- function onExitTab
-------------------------------------
function UI_RuneForgeGachaTicketTab:onExitTab()
end

-------------------------------------
-- function initUI
-------------------------------------
function UI_RuneForgeGachaTicketTab:initUI()
...
-- function update
-------------------------------------
function UI_RuneForgeGachaTicketTab:update(dt)
    local vars = self.vars
end
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:click_gachaBtn(goods_type)
    -- 조건 체크
...
-- @brief 이어서 뽑기 설정
-------------------------------------
function UI_RuneForgeGachaTicketTab:subsequentSummons(gacha_result_ui, is_cash)
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:request_runeGacha(is_cash)
...
-- function refresh
-------------------------------------
function UI_RuneForgeGachaTicketTab:refresh()
    local vars = self.vars
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:getMileageProduct()
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:refreshMileage()
    local vars = self.vars
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:refreshTabNoti()
    local vars = self.vars
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:click_ChangeBtn(myTab)
    local vars = self.vars
    self.m_myTab = myTab
    self:refresh()
...
-- @brief 선택권 리스트
-------------------------------------
function UI_RuneForgeGachaTicketTab:click_rewardInfoBtn()
...
-- @brief 마일리지 상품 구매
-------------------------------------
function UI_RuneForgeGachaTicketTab:click_rewardBtn()
    local struct_product = self:getMileageProduct()
    if struct_product == nil then
        return
    end
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:getRuneBoxIcon()
    local myTab = self.m_myTab
...
-------------------------------------
function UI_RuneForgeGachaTicketTab:setRuneBoxString()
    local vars = self.vars
    local myTab = self.m_myTab
