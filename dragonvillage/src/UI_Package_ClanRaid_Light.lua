...
----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Light
----------------------------------------------------------------------
UI_Package_ClanRaid_Light = class(PARENT, {
...
-- -- function init
-- ----------------------------------------------------------------------
function UI_Package_ClanRaid_Light:init(struct_product, is_popup)
    self.m_uiName = 'UI_Package_ClanRaid_Light'
    -- @UI_ACTION
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Light:initMember()
end

----------------------------------------------------------------------
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_Light:initUI()
    self:initMember()
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_Light:initButton(is_popup)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Light:refresh()
    PARENT.refresh(self)
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_Light:initTableView()
    local vars = self.vars

    local product_id = self.m_structProduct['product_id']

    cclog('--------------------------------------------------------------')
    cclog('product_id Light : ' .. product_id)
    cclog('--------------------------------------------------------------')
    ...
    local node
    local isPackagePurchased = g_clanDungeonLightPackageData:isPackageActive(product_id)
    ...
    local item_list = g_clanDungeonLightPackageData:getPackageTable(product_id)
    ...
    tableview:setCellUIClass(UI_Package_ClanRaid_LightListItem, create_func)
    tableview:setDirection(cc.SCROLLVIEW_DIRECTION_VERTICAL)
    tableview:setItemList(item_list, true)
    self.m_tableview = tableview

    if g_clanDungeonLightPackageData:isPackageActive(product_id) then
        local isReceivableReward = false
        local target_index
        for key, data in pairs(item_list) do
            local dungeon_score = data['achive_2']
            local isRewardReceived = g_clanDungeonLightPackageData:isRewardReceived(product_id, dungeon_score)
    
            local curr_score = g_clanRaidData:getClanDungeonLightScore()
...
----------------------------------------------------------------------
function UI_Package_ClanRaid_Light:buyCallback(ret)
    ...
    g_clanDungeonLightPackageData:request_info(self.m_structProduct['product_id'], callback)
end

----------------------------------------------------------------------
-- class UI_Package_ClanRaid_Light
----------------------------------------------------------------------
UI_Package_ClanRaid_LightListItem = class(class(UI, ITableViewCell:getCloneTable()), {
    m_data = 'table',
    m_productId = 'string',
    m_stageId = '',
...
-- function init
----------------------------------------------------------------------
function UI_Package_ClanRaid_LightListItem:init(data)
    self.m_data = data
...
-- function initUI
----------------------------------------------------------------------
function UI_Package_ClanRaid_LightListItem:initUI()
    local vars = self.vars
...
-- function initButton
----------------------------------------------------------------------
function UI_Package_ClanRaid_LightListItem:initButton()
    local vars = self.vars
...
-- function refresh
----------------------------------------------------------------------
function UI_Package_ClanRaid_LightListItem:refresh()
    local vars = self.vars
...
----------------------------------------------------------------------
function UI_Package_ClanRaid_LightListItem:click_rewardBtn()
    local product_id = self.m_data['product_id']
    ...
    g_clanDungeonLightPackageData:request_reward(product_id, dunegon_score, success_cb, fail_cb)
end