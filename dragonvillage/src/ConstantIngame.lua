...
FEVER_POINT_INCREMENT_VALUE['hero_basic_skill'] = 0
FEVER_POINT_INCREMENT_VALUE['hero_active_skill'] = 35
FEVER_POINT_INCREMENT_VALUE['hit_active'] = 0
FEVER_POINT_INCREMENT_VALUE['hit_active_buff'] = 0
FEVER_POINT_INCREMENT_VALUE['character_casting_cancel'] = 0
