...
-------------------------------------
-- class UI_MatchReadyArenaNew
-------------------------------------
UI_MatchReadyArenaNew = class(PARENT,{
    })

-------------------------------------
-- function init
-------------------------------------
function UI_MatchReadyArenaNew:init()
...
-------------------------------------
function UI_MatchReadyArenaNew:initParentVariable()
    -- ITopUserInfo_EventListener의 맴버 변수들 설정
    self.m_uiName = 'UI_MatchReadyArenaNew'
...
-- @brief 출전 덱 변경
-------------------------------------
function UI_MatchReadyArenaNew:click_deckBtn()
...
-- @brief 시작 버튼
-------------------------------------
function UI_MatchReadyArenaNew:click_startBtn()
...
-------------------------------------
function UI_MatchReadyArenaNew:getStructUserInfo_Player()
...
-------------------------------------
function UI_MatchReadyArenaNew:getStructUserInfo_Opponent()
...
-------------------------------------
function UI_MatchReadyArenaNew:initStaminaInfo()
    local vars = self.vars
...
-------------------------------------
function UI_MatchReadyArenaNew:initChallengeModeUI()
    local vars = self.vars
...
-- @brief 난이도 선택
-------------------------------------
function UI_MatchReadyArenaNew:make_UIC_SortList()
    local vars = self.vars
...
-------------------------------------
function UI_MatchReadyArenaNew:click_selectDifficultyBtn(point)
...
-------------------------------------
function UI_MatchReadyArenaNew:makePointRichText(point)
    local point_color
