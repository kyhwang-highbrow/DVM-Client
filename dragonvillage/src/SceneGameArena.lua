...
-------------------------------------
-- class SceneGameArena
-------------------------------------
SceneGameArena = class(PARENT, {
...
-- function init
-------------------------------------
function SceneGameArena:init(game_key, stage_id, stage_name, develop_mode, friend_match)
    self.m_stageName = 'stage_colosseum'
    self.m_bDevelopMode = develop_mode
    self.m_bFriendMatch = friend_match or false

    self.m_sceneName = 'SceneGameArena'
...
-- function onEnter
-------------------------------------
function SceneGameArena:onEnter()
    g_gameScene = self
...
-- function onExit
-------------------------------------
function SceneGameArena:onExit()
    PARENT.onExit(self)
...
-------------------------------------
function SceneGameArena:prepareAfter()
...
-------------------------------------
function SceneGameArena:prepareDone()
...
-- @breif
-------------------------------------
function SceneGameArena:networkGameFinish(t_param, t_result_ref, next_func)
...
-------------------------------------
function SceneGameArena:networkGameFinish_response(ret, t_result_ref)
...
-------------------------------------
function SceneGameArena:networkGameFinish_response_user_info(ret, t_result_ref)
...
-------------------------------------
function SceneGameArena:networkGameFinish_response_modified_dragons(ret, t_result_ref)
...
-------------------------------------
function SceneGameArena:networkGameFinish_response_added_dragons(ret, t_result_ref)
...
-- @breif 드랍 보상 데이터 처리
-------------------------------------
function SceneGameArena:networkGameFinish_response_drop_reward(ret, t_result_ref)
...
-- @breif
-------------------------------------
function SceneGameArena:networkGameFinish_response_stage_clear_info(ret)
