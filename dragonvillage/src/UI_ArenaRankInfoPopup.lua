...
-------------------------------------
-- class UI_ArenaRankInfoPopup
-------------------------------------
UI_ArenaRankInfoPopup = class(PARENT,{
    })
...
function UI_ArenaRankInfoPopup:init()
    ...
    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:close() end, 'UI_ArenaRankInfoPopup')
...
-- function initUI
-------------------------------------
function UI_ArenaRankInfoPopup:initUI()
...
-- function initButton
-------------------------------------
function UI_ArenaRankInfoPopup:initButton()
    local vars = self.vars
...
-- function refresh
-------------------------------------
function UI_ArenaRankInfoPopup:refresh()
    local vars = self.vars
...
--@CHECK
UI:checkCompileError(UI_ArenaRankInfoPopup)
