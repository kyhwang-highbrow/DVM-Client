...
function UI_Forest_ChangePopup:save_dragonSortInfo()
    ...
    g_settingData:applySettingData(sort_order, 'dragon_sort_forest', 'order')

    -- 오름차순, 내림차순 저장
    local ascending = self.m_mtrlDragonSortManager.m_defaultSortAscending
    g_settingData:applySettingData(ascending, 'dragon_sort_forest', 'ascending')
...
function UI_Forest_ChangePopup:apply_mtrlDragonSort_saveData()
    local l_order = g_settingData:get('dragon_sort_forest', 'order') or g_settingData:get('dragon_sort_fight', 'order')
    local ascending = g_settingData:get('dragon_sort_forest', 'ascending')
