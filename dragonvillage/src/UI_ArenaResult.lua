-------------------------------------
-- class UI_ArenaResult
-------------------------------------
UI_ArenaResult = class(UI, {
        m_isWin = 'boolean',
        m_resultData = '',
...
function UI_ArenaResult:init(is_win, t_data)
    ...
    -- 백키 지정
    g_currScene:pushBackKeyListener(self, function() self:click_okBtn() end, 'UI_ArenaResult')
...
-- function initUI
-------------------------------------
function UI_ArenaResult:initUI()
...
-- function initButton
-------------------------------------
function UI_ArenaResult:initButton()
    local vars = self.vars
...
-------------------------------------
function UI_ArenaResult:setWorkList()
    self.m_workIdx = 0
    self.m_lWorkList = {}
...
-------------------------------------
function UI_ArenaResult:direction_showTamer()
...
-------------------------------------
function UI_ArenaResult:direction_showTamer_click()
    self:doNextWork()
end
...
-------------------------------------
function UI_ArenaResult:direction_hideTamer()
    local vars = self.vars
    local tamer_node = vars['tamerNode']
...
-------------------------------------
function UI_ArenaResult:direction_hideTamer_click()
end
...
-- @brief 시작 연출
-------------------------------------
function UI_ArenaResult:direction_start()
    local is_win = self.m_isWin
    local vars = self.vars
...
-------------------------------------
function UI_ArenaResult:direction_start_click()
end
...
-- @brief 종료 연출
-------------------------------------
function UI_ArenaResult:direction_end()
    local vars = self.vars
...
-------------------------------------
function UI_ArenaResult:direction_winReward()
	local t_data = self.m_resultData
...
-------------------------------------
function UI_ArenaResult:direction_masterRoad()
    -- @ MASTER ROAD
...
-------------------------------------
function UI_ArenaResult:direction_masterRoad_click()
end

-------------------------------------
-- function doNextWork
-------------------------------------
function UI_ArenaResult:doNextWork()
...
-------------------------------------
function UI_ArenaResult:doNextWorkWithDelayTime(second)
...
-------------------------------------
function UI_ArenaResult:click_statsBtn()
...
-------------------------------------
function UI_ArenaResult:click_screenBtn()
...
-------------------------------------
function UI_ArenaResult:click_statusInfo()
    UI_HelpStatus()
end
