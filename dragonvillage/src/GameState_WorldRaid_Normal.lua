...
-------------------------------------
-- class GameState_WorldRaid_Normal
-------------------------------------
GameState_WorldRaid_Normal = class(PARENT, {
        m_orgBossHp = 'number',
        m_bossHp = 'number',
        m_bossMaxHp = 'number',
...
-- function init
-------------------------------------
function GameState_WorldRaid_Normal:init(world)
...
-------------------------------------
function GameState_WorldRaid_Normal:initState()
    PARENT.initState(self)
    self:addState(GAME_STATE_START, GameState_WorldRaid_Normal.update_start)
    self:addState(GAME_STATE_FIGHT, GameState_WorldRaid_Normal.update_fight)
    self:addState(GAME_STATE_RESULT, GameState_WorldRaid_Normal.update_result)
end

-------------------------------------
-- function update_start
-------------------------------------
function GameState_WorldRaid_Normal.update_start(self, dt)
...
-------------------------------------
function GameState_WorldRaid_Normal:doDirectionForIntermission()
    local t_camera_info = {}
...
-------------------------------------
function GameState_WorldRaid_Normal.update_fight(self, dt)
    local world = self.m_world
...
-------------------------------------
function GameState_WorldRaid_Normal.update_result(self, dt)
    if (self.m_stateTimer == 0) then
...
-- function makeBossHp
-------------------------------------
function GameState_WorldRaid_Normal:makeBossHp()
    local world = self.m_world
...
-------------------------------------
function GameState_WorldRaid_Normal:makeResultUI(is_success)
...
-------------------------------------
function GameState_WorldRaid_Normal:disappearAllDragon()
...
-- @brief
-------------------------------------
function GameState_WorldRaid_Normal:onEvent(event_name, t_event, ...)
...
-------------------------------------
function GameState_WorldRaid_Normal:processTimeOut()
...
-------------------------------------
function GameState_WorldRaid_Normal:getTotalDamage()
...
--- @return integer
-------------------------------------
function GameState_WorldRaid_Normal:getRemainFeverTime()
...
-------------------------------------
function GameState_WorldRaid_Normal:updateFightTimer(dt)
