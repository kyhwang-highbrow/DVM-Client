...
-------------------------------------
-- class GameState_WorldRaid_Cooperation
-------------------------------------
GameState_WorldRaid_Cooperation = class(PARENT, {
        m_orgBossHp = 'number',
        m_bossHp = 'number',
        m_bossMaxHp = 'number',
...
-- function init
-------------------------------------
function GameState_WorldRaid_Cooperation:init(world)
...
-------------------------------------
function GameState_WorldRaid_Cooperation:initState()
    PARENT.initState(self)
    self:addState(GAME_STATE_START, GameState_WorldRaid_Cooperation.update_start)
    self:addState(GAME_STATE_FIGHT, GameState_WorldRaid_Cooperation.update_fight)
    self:addState(GAME_STATE_RESULT, GameState_WorldRaid_Cooperation.update_result)
end

-------------------------------------
-- function update_start
-------------------------------------
function GameState_WorldRaid_Cooperation.update_start(self, dt)
...
-------------------------------------
function GameState_WorldRaid_Cooperation:doDirectionForIntermission()
    local t_camera_info = {}
...
-------------------------------------
function GameState_WorldRaid_Cooperation.update_fight(self, dt)
    local world = self.m_world
...
-------------------------------------
function GameState_WorldRaid_Cooperation.update_result(self, dt)
    if (self.m_stateTimer == 0) then
...
-- function makeBossHp
-------------------------------------
function GameState_WorldRaid_Cooperation:makeBossHp()
    local world = self.m_world
...
-------------------------------------
function GameState_WorldRaid_Cooperation:makeResultUI(is_success)
...
-------------------------------------
function GameState_WorldRaid_Cooperation:disappearAllDragon()
...
-- @brief
-------------------------------------
function GameState_WorldRaid_Cooperation:onEvent(event_name, t_event, ...)
...
-------------------------------------
function GameState_WorldRaid_Cooperation:processTimeOut()
...
-------------------------------------
function GameState_WorldRaid_Cooperation:getTotalDamage()
...
--- @return integer
-------------------------------------
function GameState_WorldRaid_Cooperation:getRemainFeverTime()
...
-------------------------------------
function GameState_WorldRaid_Cooperation:updateFightTimer(dt)
