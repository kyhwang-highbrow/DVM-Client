...
-------------------------------------
UI_GameResult_Dmgate = class(PARENT, {
...
-- @param body
-------------------------------------
function UI_GameResult_Dmgate:init(stage_id, is_success, time, gold, t_tamer_levelup_data, l_dragon_list, box_grade, l_drop_item_list, secret_dungeon, content_open) 
end
...
-- @param body
-------------------------------------
function UI_GameResult_Dmgate:init_difficultyIcon(stage_id) 
...
-------------------------------------
function UI_GameResult_Dmgate:set_modeButton() 
    local vars = self.vars
    ...
    vars['contentLabel']:setString(Str('차원문'))
...
-------------------------------------
function UI_GameResult_Dmgate:direction_showBox()
    self:doNextWork()
end
...
-- 차원문의 경우 별도의 보상이 없으므로 보상 연출 삭제를 위함.
-------------------------------------
function UI_GameResult_Dmgate:direction_openBox()
    self:doNextWork()
end
...
-- 차원문의 경우 별도의 보상이 없으므로 보상 연출 삭제를 위함.
-------------------------------------
function UI_GameResult_Dmgate:direction_dropItem()
    self:doNextWork()
end
-------------------------------------
...
-- @brief 바로 재시작
-------------------------------------
function UI_GameResult_Dmgate:click_againBtn() 
...
-- @brief 
-------------------------------------
function UI_GameResult_Dmgate:click_contentBtn() 
