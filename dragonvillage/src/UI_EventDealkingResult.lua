-------------------------------------
-- class UI_EventDealkingResult
-------------------------------------
UI_EventDealkingResult = class(UI, {
    m_stageID = 'number',
    m_bSuccess = 'boolean',
    m_data = '', -- 등급, 보상 정보
    m_damage = 'number', -- 피해량
...
function UI_EventDealkingResult:init(stage_id, is_success, damage, t_data)
    ...
    -- 백키 지정
    g_currScene:pushBackKeyListener(self, function() self:click_okBtn() end, 'UI_EventDealkingResult')
...
-- function initButton
-------------------------------------
function UI_EventDealkingResult:initButton()
    local vars = self.vars
...
-------------------------------------
function UI_EventDealkingResult:setWorkList()
    self.m_workIdx = 0
    self.m_lWorkList = {}
    -- 테이머 연출 미정
...
-------------------------------------
function UI_EventDealkingResult:direction_showTamer()
end

-------------------------------------
-- function direction_showTamer_click
-------------------------------------
function UI_EventDealkingResult:direction_showTamer_click()
end

-------------------------------------
-- function direction_hideTamer
-------------------------------------
function UI_EventDealkingResult:direction_hideTamer()
end

-------------------------------------
-- function direction_hideTamer_click
-------------------------------------
function UI_EventDealkingResult:direction_hideTamer_click()
end
...
-- @brief 시작 연출
-------------------------------------
function UI_EventDealkingResult:direction_start()
...
-------------------------------------
function UI_EventDealkingResult:direction_start_click()
end
...
-- @brief 점수 연출
-------------------------------------
function UI_EventDealkingResult:direction_showScore()
    local is_win = self.m_bSuccess
    local vars = self.vars
...
-------------------------------------
function UI_EventDealkingResult:direction_showScore_click()
end
...
-- @brief 등급별 연출
-------------------------------------
function UI_EventDealkingResult:direction_showStar()
    local vars = self.vars
...
-------------------------------------
function UI_EventDealkingResult:direction_showStar_click()
end
...
-- @brief 보상 연출
-------------------------------------
function UI_EventDealkingResult:direction_showReward()
    local vars = self.vars
...
-------------------------------------
function UI_EventDealkingResult:show_item_reward(reward_menu)
...
-------------------------------------
function UI_EventDealkingResult:setItemCardRarity(item_card, grade)
    if (grade > 3) then
...
-------------------------------------
function UI_EventDealkingResult:getItemCard(data)
...
-------------------------------------
function UI_EventDealkingResult:direction_showReward_click()
...
-------------------------------------
function UI_EventDealkingResult:initReward()
    local vars = self.vars
    local grade = self.m_grade
end
...
-- @brief 종료 연출
-------------------------------------
function UI_EventDealkingResult:direction_end()
    local vars = self.vars
...
-- function doNextWork
-------------------------------------
function UI_EventDealkingResult:doNextWork()
...
-------------------------------------
function UI_EventDealkingResult:doNextWorkWithDelayTime(second)
...
-------------------------------------
function UI_EventDealkingResult:click_statsBtn()
...
-------------------------------------
function UI_EventDealkingResult:click_statusInfo()
    UI_HelpStatus()
end
...
-------------------------------------
function UI_EventDealkingResult:click_screenBtn()
