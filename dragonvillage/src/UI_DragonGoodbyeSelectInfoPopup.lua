...
local INFO_TEXT = {}
INFO_TEXT['relation'] = {
                        '인연포인트는 드래곤의 강화 레벨을 올릴 때 사용합니다.',
                        '강화 레벨이 증가하면 드래곤의 생명력, 방어력, 공격력이 증가합니다.',
                        '작별을 통해 해당 드래곤의 인연포인트를 얻을 수 있습니다.', 
                        '작별하려는 드래곤의 인연포인트가 보유 한도를 초과하면 인연포인트로 작별할 수 없습니다.', 
                        }
INFO_TEXT['mastery'] = {
                        '특성 재료는 드래곤의 특성 레벨을 올릴 때 사용합니다.',
                        '작별을 통해 해당 드래곤과 동일한 등급과 속성의 특성 재료를 얻을 수 있습니다.', 
                        '일반 희귀도의 드래곤은 특성 재료로 작별할 수 없습니다.', 
                       }
INFO_TEXT['exp'] = {
                '드래곤 경험치는 드래곤 레벨을 올릴 때 사용합니다.',
                '작별을 통해 드래곤 경험치를 얻을 수 있습니다.',
                }
...
function UI_DragonGoodbyeSelectInfoPopup:initUI()
    ...
    for idx, text in ipairs(text_list) do
        ...
        vars['infoLabel' .. idx]:setString(Str(text))
    end
end
