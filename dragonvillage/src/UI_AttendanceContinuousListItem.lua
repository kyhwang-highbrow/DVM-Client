...
-------------------------------------
-- class UI_AttendanceContinuousListItem
-------------------------------------
UI_AttendanceContinuousListItem = class(PARENT, {
        m_tItemData = 'table',
    })
...
-- function init
-------------------------------------
function UI_AttendanceContinuousListItem:init(t_item_data)
...
-- function initUI
-------------------------------------
function UI_AttendanceContinuousListItem:initUI()
...
-- function initButton
-------------------------------------
function UI_AttendanceContinuousListItem:initButton()
    local vars = self.vars
...
-- function refresh
-------------------------------------
function UI_AttendanceContinuousListItem:refresh()
end

-------------------------------------
-- function click_clickBtn
-------------------------------------
function UI_AttendanceContinuousListItem:click_clickBtn()
...
-------------------------------------
function UI_AttendanceContinuousListItem:getToolTipDesc()
