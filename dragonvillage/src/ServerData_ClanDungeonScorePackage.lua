...
--------------------------------------------------------------------------
-- class ServerData_ClanDungeonScorePackage
--------------------------------------------------------------------------
ServerData_ClanDungeonScorePackage = class({
...
-- function init
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:init()
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:request_info(product_id, cb_func, fail_cb)
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:response_info(product_info, product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:request_reward(product_id, stage, cb_func, fail_cb)
    local uid = g_userData:get('uid')
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:response_reward(ret, product_id)
    local _product_id = tostring(product_id)
...
-- function response_reward
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:getPackageTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:convertPackageTableKey()
    local package_table = TABLE:get(self.m_tableName)
    local result = {}
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:checkProductInTable(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:isPackageActive(product_id)
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:isRewardReceived(product_id, stage_id)
    --if (not self.m_packageInfo[tostring(product_id)]) then return false end
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:getProductIdWithDmgateID(dmgate_id)
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:isVisibleAtBattlePassShop()
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:isNotiVisible()
    local package_table = self:getPackageTable()
    local product_id
    local stage_id
        ...
        for i, v in pairs(package_table) do
            for key, data in pairs(v) do
                ...
                if self:isPackageActive(product_id) then
                    ...
                    and g_clanData:isStageEverCleared(stage_id) then
                        return true
                    end
                else
                    break
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:isUnclearedAnyPackage()
...
--------------------------------------------------------------------------
function ServerData_ClanDungeonScorePackage:isPackageVisible(product_id)
    if (g_contentLockData:isContentLock('clan')) then 
        return false
    end
...
--function ServerData_ClanDungeonScorePackage:getProductIdWithMatched
