...
-------------------------------------
-- class UI_1030X640_FirstPurchaseReward
-- @brief 첫 충전 선물
-------------------------------------
UI_1030X640_FirstPurchaseReward = class(PARENT,{
        m_eventId = 'string',
    })
...
-- function init
-------------------------------------
function UI_1030X640_FirstPurchaseReward:init(event_id)
    self.m_eventId = event_id

    self.m_uiName = 'UI_1030X640_FirstPurchaseReward'
    ...
    -- backkey 지정
    --g_currScene:pushBackKeyListener(self, function() self:close() end, 'UI_1030X640_FirstPurchaseReward')
...
-- function initUI
-------------------------------------
function UI_1030X640_FirstPurchaseReward:initUI()
...
-- function initButton
-------------------------------------
function UI_1030X640_FirstPurchaseReward:initButton()
    local vars = self.vars
...
-- function refresh
-------------------------------------
function UI_1030X640_FirstPurchaseReward:refresh()
    local vars = self.vars
...
-- function update
-------------------------------------
function UI_1030X640_FirstPurchaseReward:update(dt)
    local vars = self.vars
...
-------------------------------------
function UI_1030X640_FirstPurchaseReward:click_shopBtn()
    self:close()
...
-------------------------------------
function UI_1030X640_FirstPurchaseReward:click_rewardBtn()
...
-------------------------------------
function UI_1030X640_FirstPurchaseReward:click_contractBtn()
    GoToAgreeMentUrl()
end
...
-------------------------------------
function UI_1030X640_FirstPurchaseReward:getDataByKey(key)
...
--@CHECK
UI:checkCompileError(UI_1030X640_FirstPurchaseReward)
