...
function UI_InvenDevApiPopup:init_dragonTableView()
    ...
    local function create_func(ui, data)
        ...
        local label = cc.Label:createWithTTF(name, Translate:getFontPath(), 22, 1, cc.size(600, 50), 1, 1)
...
function UI_InvenDevApiPopup:init_fruitTableView()
    ...
    local function create_func(ui, data)
        ...
        local label = cc.Label:createWithTTF(table_fruit[fruit_id]['t_name'], Translate:getFontPath(), 20, 1, cc.size(600, 50), 1, 1)
        label:setDockPoint(cc.p(0.5, 0.5))
        label:setAnchorPoint(cc.p(0.5, 0.5))
        label:setPositionY(50)
        ui.root:addChild(label)
