...
function TranslateExtractor:extractUIFiles()
    local root_dir = '\\..\\res\\'
    -- UIĆÄŔĎľéżĄź­ ľĽŔĚĹÍ¸Ś ŔĐžîżÂ´Ů.
    -- ŔĚ °úÁ¤Ŕť °ĹÄĄ¸é t_translateŔş key = ĆÄŔĎ ŔĚ¸§, value = ÇŃąŰ string
...
function TranslateExtractor:extractLuaFiles()
    local root_dir = '\\..\\src\\'
    -- LuaĆÄŔĎľéżĄź­ ľĽŔĚĹÍ¸Ś ŔĐžîżÂ´Ů.
    -- ŔĚ °úÁ¤Ŕť °ĹÄĄ¸é, t_translateŔş key = ĆÄŔĎ ŔĚ¸§, value = ÇŃąŰ string
...
function TranslateExtractor:extractCSVFiles()
    local root_dir = '\\..\\data\\'
    -- CSVĆÄŔĎľéżĄź­ ľĽŔĚĹÍ¸Ś ŔĐžîżÂ´Ů.
    -- ŔĚ °úÁ¤Ŕť °ĹÄĄ¸é, t_translateŔş key = ĆÄŔĎ ŔĚ¸§, value = ÇŃąŰ string
