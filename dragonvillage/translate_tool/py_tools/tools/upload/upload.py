...
from tools.upload.upload_DVM_plain_text import direct_upload_DVM_plain_text
from tools.upload.upload_DVM_scenario_text import upload_DVM_scenario_text
from tools.upload.upload_DVM_scenario_text import direct_upload_DVM_scenario_text
