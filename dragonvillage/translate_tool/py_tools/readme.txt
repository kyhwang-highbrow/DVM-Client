...
2. 패치 파일 생성을 위해 델타 번역 파일을 생성할 때
    2-1. make_delta_lua.py 실행하여 현재 사용되는 번역 파일과 업데이트된 스프레드시트와 비교해서 델타 번역 파일 생성
    2-2. make_origin_lua.py 실행하여 원본 번역 파일 업데이트 및 기존 파일 백업
    2-3. 패치 파일 생성
