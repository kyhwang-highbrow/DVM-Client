...
def merge_backup():
    global sheet, work_sheets, spreadsheet_key, sheet_name, all_data_list, header, is_scenario
    ...
    upload(sheet_name + '_backup', spreadsheet_key, all_data_list, header, locale_list, is_scenario=is_scenario)
