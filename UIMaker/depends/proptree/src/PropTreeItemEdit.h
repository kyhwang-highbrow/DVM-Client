...
public:
	...
	virtual void OnActivate(CPoint ptz);

	virtual void OpenEdit();

	void SetItem(int v);
	void SetItem(unsigned int v);
	void SetItem(long long v);
	void SetItem(unsigned long long v);
	void SetItem(float v);
	void SetItem(double v);
	void SetItem(const CString& v);

	int GetItem_Int32();
	unsigned int GetItem_UInt32();
	long long GetItem_Int64();
	unsigned long long GetItem_UInt64();
	float GetItem_Float();
	double GetItem_Double();
	CString GetItem_String();
	...
	enum ValueFormat
	{
		...
		ValueFormat_NeedFileDialog,
		ValueFormat_FILE,
		ValueFormat_FILE_IMAGE,
		ValueFormat_FILE_SOUND,
		ValueFormat_FILE_BMFONT,
		ValueFormat_FILE_TTF,
		ValueFormat_FILE_VISUAL,
		ValueFormat_FILE_PLIST,
	};
