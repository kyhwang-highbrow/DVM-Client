...
-------------------------------------
-- class UI_SkillDetailPopupNew
-------------------------------------
UI_SkillDetailPopupNew = class(PARENT, {
...
function UI_SkillDetailPopupNew:init(dragon_object, focus_idx)
    ...
    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:click_closeBtn() end, 'UI_SkillDetailPopupNew')
...
-- function initUI
-------------------------------------
function UI_SkillDetailPopupNew:initUI()
...
-- function refresh
-------------------------------------
function UI_SkillDetailPopupNew:refresh(idx)
    local vars = self.vars
...
-------------------------------------
function UI_SkillDetailPopupNew:makeDragonData(data)
    local t_dragon = data
...
-------------------------------------
function UI_SkillDetailPopupNew:makeSkillRadioBtn(focus_idx)
	local vars = self.vars
...
-------------------------------------
function UI_SkillDetailPopupNew:onChangeOption()
...
-------------------------------------
function UI_SkillDetailPopupNew:toggleButton()
	local vars = self.vars
...
-- @brief 같은 타입 드래곤 클릭시
-------------------------------------
function UI_SkillDetailPopupNew:click_sameTypeCard(struct_dragon_object)
...
-------------------------------------
function UI_SkillDetailPopupNew:click_skillLvBtn(is_next)
	local vars = self.vars
...
-------------------------------------
function UI_SkillDetailPopupNew:click_closeBtn()
