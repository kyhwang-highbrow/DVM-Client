...
-------------------------------------
-- class UI_TamerCostumeConfirmPopup
-------------------------------------
UI_TamerCostumeConfirmPopup = class(PARENT,{
...
-- function init
-------------------------------------
function UI_TamerCostumeConfirmPopup:init(costume_data)
    ...
    -- backkey 지정
    g_currScene:pushBackKeyListener(self, function() self:click_closeBtn() end, 'UI_TamerCostumeConfirmPopup')
...
-- function initUI
-------------------------------------
function UI_TamerCostumeConfirmPopup:initUI()
    ...
    local costume_name = costume_data:getName()
    local msg = Str('{1} {2}개를 사용하여\n{3}을 구매하시겠습니까?', str_price, price, costume_name)
...
-- function initButton
-------------------------------------
function UI_TamerCostumeConfirmPopup:initButton()
    local vars = self.vars
...
-- function refresh
-------------------------------------
function UI_TamerCostumeConfirmPopup:refresh()
end

-------------------------------------
-- function click_closeBtn
-------------------------------------
function UI_TamerCostumeConfirmPopup:click_closeBtn()
    self.m_closeCB = nil
    self:close()
end
...
--@CHECK
UI:checkCompileError(UI_TamerCostumeConfirmPopup)
