...
extern const char* jniFuncS_V(const char* funcName, int funcID);
#define IMPL_LUABINDING_FUNC_S_V(funcname) \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
        ...
        { \
            ...
            const char* ret = jniFuncS_V(#funcname, funcID); \
...
#else
#define IMPL_LUABINDING_FUNC_S_V(funcname) \
    extern const char* funcname(int funcID);\
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
        ...
        { \
            int funcID = toluafix_ref_function(tolua_S, 2, 0); \
            const char* ret = funcname(funcID); \
            tolua_pushstring(tolua_S, ret); \
            return 1; \
        } \
        return 0; \
...
#if defined(__ANDROID__)
extern const char* jniFuncS_S(const char* funcName, int funcID, const char* arg0);
#define IMPL_LUABINDING_FUNC_S_S(funcname) \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
        ...
        { \
            ...
            const char* ret = jniFuncS_S(#funcname, funcID, arg0); \
            tolua_pushstring(tolua_S, ret); \
            return 1; \
        } \
        return 0; \
...
#else
#define IMPL_LUABINDING_FUNC_S_S(funcname) \
    extern const char* funcname(int funcID, const char* arg0); \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
        { \
        if (IS_DEBUG) \
        { \
        ...
        { \
            const char* arg0 = tolua_tostring(tolua_S, 2, 0); \
            int funcID = toluafix_ref_function(tolua_S, 3, 0); \
            const char* ret = funcname(funcID, arg0); \
            tolua_pushstring(tolua_S, ret); \
            return 1; \
        } \
        return 0; \
...
#if defined(__ANDROID__)
extern void jniFuncV_SI(const char* funcName, int funcID, const char* arg0, int arg1);
#define IMPL_LUABINDING_FUNC_V_SI(funcname) \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
        ...
        const char* arg0 = tolua_tostring(tolua_S, 2, 0); \
        int arg1 = tolua_tonumber(tolua_S, 3, 0); \
        int funcID = toluafix_ref_function(tolua_S, 4, 0); \
        jniFuncV_SI(#funcname, funcID, arg0, arg1); \
        return 0; \
    }
#else
#define IMPL_LUABINDING_FUNC_V_SI(funcname) \
    extern void funcname(int funcID, const char* arg0, int arg1); \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
...
#if defined(__ANDROID__)
extern void jniFuncV_SZ(const char* funcName, int funcID, const char* arg0, bool arg1);
#define IMPL_LUABINDING_FUNC_V_SZ(funcname) \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
        ...
        const char* arg0 = tolua_tostring(tolua_S, 2, 0); \
        bool arg1 = tolua_toboolean(tolua_S, 3, 0); \
        int funcID = toluafix_ref_function(tolua_S, 4, 0); \
        jniFuncV_SZ(#funcname, funcID, arg0, arg1); \
        return 0; \
    }
#else
#define IMPL_LUABINDING_FUNC_V_SZ(funcname) \
    extern void funcname(int funcID, const char* arg0, bool arg1); \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
...
#if defined(__ANDROID__)
extern void jniFuncV_SII(const char* funcName, int funcID, const char* arg0, int arg1, int arg2);
#define IMPL_LUABINDING_FUNC_V_SII(funcname) \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
        ...
        int funcID = toluafix_ref_function(tolua_S, 5, 0); \
        jniFuncV_SII(#funcname, funcID, arg0, arg1, arg2); \
        return 0; \
    }
#else
#define IMPL_LUABINDING_FUNC_V_SII(funcname) \
extern void funcname(int funcID, const char* arg0, int arg1, int arg2); \
    int tolua_PerpleSDK_##funcname(lua_State* tolua_S) \
    { \
        if (IS_DEBUG) \
        { \
