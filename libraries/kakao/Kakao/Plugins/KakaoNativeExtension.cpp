...
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
    JniHelper::getMethodInfo(method, "com/kakao/sample/Sample", "kakaoCocos2dxExtension", "(Ljava/lang/String;)V");
#endif
    return instance;
}
...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_com_kakao_sample_Sample_initJNIBridge(JNIEnv *env, jobject jobj) {
        CCLog("initJNIBridge");
        javaObj = env->NewGlobalRef(jobj);
    }

    JNIEXPORT void JNICALL Java_com_kakao_sample_Sample_sendMessageBridge(JNIEnv *env, jobject jobj, jstring target, jstring method, jstring params) {
