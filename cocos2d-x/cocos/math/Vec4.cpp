...
{
    CCASSERT(!(min.x > max.x || min.y > max.y || min.z > max.z || min.w > max.w), "Vec4::clamp");
...
{
    CCASSERT(dst, "Vec4::clamp1");
    CCASSERT(!(min.x > max.x || min.y > max.y || min.z > max.z || min.w > max.w), "Vec4::clamp 2");
