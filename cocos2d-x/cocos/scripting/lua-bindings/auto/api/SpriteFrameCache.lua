...
--------------------------------
-- overload function: addSpriteFramesWithFileNPrefix(string, string, string)
--          
-- overload function: addSpriteFramesWithFileNPrefix(string, string)
--          
-- overload function: addSpriteFramesWithFileNPrefix(string, string, cc.Texture2D)
--          
-- @function [parent=#SpriteFrameCache] addSpriteFramesWithFileNPrefix
-- @param self
-- @param #string str
-- @param #string str
-- @param #cc.Texture2D texture2d
