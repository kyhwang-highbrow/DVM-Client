...
int lua_cocos2dx_extension_ScrollView_setLimitedOffset(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::ScrollView* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_ScrollView_setLimitedOffset'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        if (!ok)
            return 0;
        cobj->setLimitedOffset(arg0);
        return 0;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "setLimitedOffset", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_ScrollView_setLimitedOffset'.", &tolua_err);
#endif
...
int lua_cocos2dx_extension_ScrollView_isLimitedOffset(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::ScrollView* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_ScrollView_isLimitedOffset'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if (!ok)
            return 0;
        bool ret = cobj->isLimitedOffset();
        tolua_pushboolean(tolua_S, (bool)ret);
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "isLimitedOffset", argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_ScrollView_isLimitedOffset'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_ScrollView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ScrollView");
        ...
        tolua_function(tolua_S,"setLimitedOffset",lua_cocos2dx_extension_ScrollView_setLimitedOffset);
        ...
        tolua_function(tolua_S,"isLimitedOffset",lua_cocos2dx_extension_ScrollView_isLimitedOffset);
...
int lua_cocos2dx_extension_EditBox_getInputMode(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EditBox* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_EditBox_getInputMode'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_EditBox_getInputMode'.", &tolua_err);
#endif
...
int lua_cocos2dx_extension_EditBox_openKeyboard(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EditBox* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_EditBox_openKeyboard'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_EditBox_openKeyboard'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_EditBox(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EditBox");
        ...
        tolua_function(tolua_S,"getInputMode", lua_cocos2dx_extension_EditBox_getInputMode);
        ...
        tolua_function(tolua_S,"openKeyboard", lua_cocos2dx_extension_EditBox_openKeyboard);
