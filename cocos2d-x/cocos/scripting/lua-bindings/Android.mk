...
LOCAL_SRC_FILES := manual/CCLuaBridge.cpp \
		  ...
		  ../../../external/lua/luabins/fwrite.c \
		  ../../../external/lua/luabins/load.c \
		  ../../../external/lua/luabins/luabins.c \
		  ../../../external/lua/luabins/luainternals.c \
		  ../../../external/lua/luabins/lualess.c \
		  ../../../external/lua/luabins/save.c \
		  ../../../external/lua/luabins/savebuffer.c \
		  ../../../external/lua/luabins/write.c \
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../external/lua/tolua \
					...
					$(LOCAL_PATH)/../../../external/lua/luabins \
                    $(LOCAL_PATH)/../../../external/lua/luajit/include \
                    $(LOCAL_PATH)/../../../external/lua \
					$(LOCAL_PATH)/../../../external/lua/luacrypto \
					$(LOCAL_PATH)/../../../external/openssl/include/android \
                    $(LOCAL_PATH)/../../../extensions \
                    $(LOCAL_PATH)/../../editor-support/spine \
                    $(LOCAL_PATH)/../../editor-support/cocosbuilder \
                    $(LOCAL_PATH)/../../editor-support/cocostudio \
					$(LOCAL_PATH)/../../editor-support/anb \
					$(LOCAL_PATH)/../../editor-support/perplelab \
                    $(LOCAL_PATH)/../../ui \
                    $(LOCAL_PATH)/auto \
                    $(LOCAL_PATH)/manual \
...
$(call import-module,editor-support/anb)
$(call import-module,editor-support/perplelab)
